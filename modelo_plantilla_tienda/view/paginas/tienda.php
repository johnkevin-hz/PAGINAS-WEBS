                    ...
                    <div class="shop__sidebar">
                        ...
                        <div class="shop__sidebar__accordion">
                            <div class="accordion" id="accordionExample">
                                        ...
                                        <div class="card-body">
                                            <div class="shop__sidebar__categories">
                                                <ul class="nice-scroll">
                                                    ...
                                                    <li><a href="#">Bolsas (20)</a></li>
                                                    <li><a href="#">Ropa (20)</a></li>
                                                    <li><a href="#">Zapatos (20)</a></li>
                                                    <li><a href="#">Accesorios (20)</a></li>
                                ...
                                <div class="card">
                                    <div class="card-heading">
                                        <a data-toggle="collapse" data-target="#collapseThree">Precio del filtro</a>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="shop__product__option__right">
                                    ...
                                    <select>
                                        <option value="">Baja A Alta</option>
                                        <option value="">S/ 0 - S/ 55</option>
                                        <option value="">S/ 55 - S/ 100</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="product__item">
                                <div class="product__item__pic set-bg" data-setbg="assets/img/product/product-2.jpg">
                                    <ul class="product__hover">
                                        ...
                                        <li><a href="#"><img src="assets/img/icon/compare.png" alt=""> <span>Comparar</span></a>
                                        </li>
